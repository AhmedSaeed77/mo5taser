{{--  matching question  --}}
<div class="row">
    <form action="{{route('questions.store')}}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" id="form_matching">
        @csrf
        @method('POST')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group no-margin">
                            ...
                            <textarea class="form-control ckeditor" name="hint" id="ckeditor{{rand(100,10000)}}" required></textarea>

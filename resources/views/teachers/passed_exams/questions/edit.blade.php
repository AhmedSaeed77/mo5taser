                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @if($question->type === 'multi_choice')
                                                @include('teachers.passed_exams.questions.multi_choice_edit')
                                            @elseif($question->type === 'true_false')
                                                @include('teachers.passed_exams.questions.true_false_edit')
                                            @elseif($question->type === 'textual')
                                                @include('teachers.passed_exams.questions.textual_edit')
                                            @elseif($question->type === 'matching')
                                                @include('teachers.passed_exams.questions.matching_edit')
                                            @endif
                                        </div>
                                    </div>
                                </div>

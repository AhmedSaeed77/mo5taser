...
<div class="row">
    <form action="{{route('questions.store')}}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        @csrf
        @method('POST')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group no-margin">
                        ...
                        <textarea class="form-control ckeditor" id="ckeditor{{rand(100,10000)}}" name="question" required>{{old('question')}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group no-margin">
                        ...
                        <textarea class="form-control ckeditor" id="ckeditor{{rand(100,10000)}}" name="question_details" required>{{old('question_details')}}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input_choice">
                            <label for="q5" class="custom_checkbox m-0">
                                <input type="radio" id="q5" value="1" name="true_answer" required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input_choice">
                            <label for="q6" class="custom_checkbox m-0">
                                <input type="radio" id="q6" value="0" name="true_answer" required="">
                                <span class="checkmark"></span>
                            </label>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input_choice">
                            <input type="number" min="1" class="form-control" id="field-1" name="degree" placeholder="@lang('lang.degree')" required >
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group no-margin">
                            ...
                            <textarea class="form-control ckeditor" name="hint" id="ckeditor{{rand(100,10000)}}">{{old('hint')}}</textarea>

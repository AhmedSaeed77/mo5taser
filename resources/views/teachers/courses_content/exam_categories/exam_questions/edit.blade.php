                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @if($question->type === 'multi_choice')
                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.multi_choice_edit')
                                            @elseif($question->type === 'true_false')
                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.true_false_edit')
                                            @elseif($question->type === 'textual')
                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.textual_edit')
                                            @elseif($question->type === 'matching')
                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.matching_edit')
                                            @endif
                                        </div>
                                    </div>
                                </div>

                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="{{route('course-units',$category->content->course_id)}}">@lang('lang.units')</a>
                                </li>
                                <li>
                                    <a href="{{route('content-courses.show',$category->content->parent->parent->id)}}">@lang('lang.course_content')</a>
                                </li>
                                <li>
                                    <a href="{{route('content.questions',$category->content->id)}}">@lang('lang.questions')</a>
                                </li>
                                <li>
                                    <a href="{{route('content-categories.show',$category->content->id)}}">@lang('lang.exam_categories')</a>
                                </li>
                                <li>
                                    <a href="{{route('content-categories-questions.show',$category->id)}}">@lang('lang.questions')</a>
                                </li>
                                <li class="active">
                                    @lang('lang.questions')
                                </li>
                            ...
                            <div class="card-box table-responsive">
                                ...
                                <div class="details">
                                    <div class="item">
                                        ...
                                        <span class="value">({{$category->questions_number}})</span>
                                    </div>
                                    <div class="item">
                                    <span>--</span>
                                    ...
                                    <div class="item">
                                    <span>--</span>
                                        <span class="name">@lang('lang.rest') ({{$category->questions_number - $questions}}) @lang('lang.question')</span>
                                    </div>
                                </div>
                                <div class="add_content">
                                    @if($category->questions_number - $questions > 0)
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="tab-content br-n pn">
                                                            <div id="navpills-11" class="tab-pane active">
                                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.multi_choice')
                                                            </div>
                                                            <div id="navpills-21" class="tab-pane">
                                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.true_false')
                                                            </div>
                                                            <div id="navpills-31" class="tab-pane">
                                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.textual')
                                                            </div>
                                                            <div id="navpills-32" class="tab-pane ">
                                                                @include('teachers.courses_content.exam_categories.exam_questions.questions.matching')
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

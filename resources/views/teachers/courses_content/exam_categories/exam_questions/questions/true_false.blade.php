...
<div class="row">
    <form action="{{route('content-categories-questions.store')}}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        @csrf
        @method('POST')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group no-margin">
                        ...
                        <textarea class="form-control ckeditor" id="ckeditor1" name="question" required>{{old('question')}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group no-margin">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group no-margin">
                            ...
                            <textarea class="form-control ckeditor" name="hint" id="ckeditor2">{{old('hint')}}</textarea>

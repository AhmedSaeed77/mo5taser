            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group no-margin">
                        ...
                        <textarea class="form-control ckeditor" id="ckeditor9" name="question_details" required>{!! $question->question_details !!}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group no-margin">
                            ...
                            <textarea class="form-control ckeditor" name="hint" id="ckeditor2">{!! $question->hint !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>

                        ...
                        <div class="row">
							<div class="col-sm-12">
								<ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="{{route('content-categories.show',$content->id)}}">@lang('lang.exam_categories')</a>
                                    </li>
									<li class="active">
                                        @lang('lang.questions')
									</li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="font-13 m-b-30 text-right">
                                        <a href="{{ route('content-categories-questions-create', $category->id) }}">
                                                ...
                                                @foreach ($questions as $key => $question)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{route('content-categories-questions.edit' ,$question->id )}}">

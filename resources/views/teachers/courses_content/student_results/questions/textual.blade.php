            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        placeholder="@lang('lang.video_url')"  value="{{ $answer->question->video_url }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group no-margin">
                            ...
                            <textarea class="form-control" name="hint" id="ckeditor2" readonly>{!! $answer->question->hint !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="input_choice">
                            <textarea class="form-control" placeholder="@lang('lang.student_answer')" readonly>{{ $answer->student_answer }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">

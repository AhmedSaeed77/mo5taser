                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @if($answer->question->type === 'multi_choice')
                                                @include('teachers.courses_content.student_results.questions.multi_choice')
                                            @elseif($answer->question->type === 'true_false')
                                                @include('teachers.courses_content.student_results.questions.true_false')
                                            @elseif($answer->question->type === 'textual')
                                                @include('teachers.courses_content.student_results.questions.textual')
                                            @elseif($answer->question->type === 'matching')
                                                @include('teachers.courses_content.student_results.questions.matching')
                                            @endif
                                        </div>
                                    </div>
                                </div>

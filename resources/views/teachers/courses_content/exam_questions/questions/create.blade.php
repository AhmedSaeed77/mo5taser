                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="{{route('content.questions',$content->id)}}">@lang('lang.questions')</a>
                                </li>
                                <li class="active">
                            ...
                            <div class="card-box table-responsive">
                                ...
                                <div class="details">
                                    <div class="item">
                                        ...
                                        <span class="value">({{$content->questions_number}})</span>
                                    </div>
                                    @if($content->exam_time)
                                        <div class="item">
                                        <span>--</span>
                                            <span class="name">@lang('lang.exam_time') :</span>
                                            <span class="value">({{$content->exam_time}}) @lang('lang.mins')</span>
                                        </div>
                                    @endif
                                    <div class="item">
                                    <span>--</span>
                                    ...
                                    <div class="item">
                                    <span>--</span>
                                        <span class="name">@lang('lang.rest') ({{$content->questions_number - $questions}}) @lang('lang.question')</span>
                                    </div>
                                </div>
                                <div class="add_content">
                                    @if($content->questions_number - $questions > 0)
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="tab-content br-n pn">
                                                            <div id="navpills-11" class="tab-pane active">
                                                                @include('teachers.courses_content.exam_questions.questions.multi_choice')
                                                            </div>
                                                            <div id="navpills-21" class="tab-pane">
                                                                @include('teachers.courses_content.exam_questions.questions.true_false')
                                                            </div>
                                                            <div id="navpills-31" class="tab-pane">
                                                                @include('teachers.courses_content.exam_questions.questions.textual')
                                                            </div>
                                                            <div id="navpills-32" class="tab-pane ">
                                                                @include('teachers.courses_content.exam_questions.questions.matching')
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

...
<script>
    $(document).ready(function() {
        var qcount = $('#qcount').data('qcount');

        /* $('#questionForm #send-answers').on('click', function(e) {

            e.preventDefault();

            if ($('#questionForm input[type="radio"]:checked').length == qcount) {
                $('#questionForm').submit();
            } else {
                alert('يجب عليك حل جميع الأسئلة أولا')
            }

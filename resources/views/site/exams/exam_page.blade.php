...
<div class="breadcrumbs wow animate__animated animate__fadeInUp">
    <div class="container">
        ...
        <span class="current">{{$exam->levelCat->title}}</span>
    </div>
</div>
<!--========================== End page header =============================-->
                ...
                <div class="col-lg-8 o-2">
                    <div class="exam_box">
                        <div class="content_box">
                            <form action="{{route('exam_submit')}}" method="POST" id="questionForm">
                                @csrf
                                @method('POST')
                                <div class="all_questions">
                                    @foreach ($questions as $key => $question)
                                        ...
                                        @if ($question->type == 'multi_choice')
                                           @include('site.exams.questions.multi_choice')
                                        @elseif ($question->type == 'true_false')
                                           @include('site.exams.questions.true_false')
                                        @elseif ($question->type == 'textual')
                                           @include('site.exams.questions.textual')
                                        @elseif ($question->type == 'matching')
                                           @include('site.exams.questions.matching')
                                        @endif
                                    @endforeach

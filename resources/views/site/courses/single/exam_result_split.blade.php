    ...
    <section class="details_of_exam_page">
        <div class="container">
            <div class="content_section wow animate__animated animate__fadeInUp">
                <h5 class="head">@lang('lang.result_of') ({{$exam->content->title}} - {{$exam->contentCategory->name}})</h5>
                @php
                $questions = \App\Models\Question::where('content_category_id' , $exam->content_category_id)->get();
                $answers = \App\Models\StudentAnswer::where('attemp_id',$exam->id)->get();
                $right_answers = App\Models\StudentAnswer::where('attemp_id',$exam->id)->where(['type' => '1'])->get();
                        ...
                        <div class="result_box">
                            ...
                            <div class="inside">
                                ...
                                <div class="text-center">
                                    <a href="{{route('single-course',$exam->content->parent->parent->parent->id)}}" class="btn-form btn-youtube">@lang('lang.back_to_course')</a>
                                </div>
                                <br>
                            </div>
                        </div>

            ...
            <div class="question_answers">
                <div class="row">
                    <div class="col-md-6">
                        <div class="single_answer">
                            <div class="item  flex-center-h
                                {{$student_answer != 0 || $student_answer == 'not_answered' ? 'wrong' : ''}}
                                {{$question->true_answer == 1 ? 'correct' : ''}}
                                ">
                                <span class="checkmark"></span>
                                <span class="text">@lang('lang.true')</span>
                                @if($student_answer != 0 || $student_answer == 'not_answered')
                    ...
                    <div class="col-md-6">
                        <div class="single_answer">
                            <div class="item  flex-center-h
                                {{$student_answer != 1 || $student_answer == 'not_answered' ? 'wrong' : ''}}
                                {{$question->true_answer == 0 ? 'correct' : ''}}
                                ">
                                <span class="checkmark"></span>
                                <span class="text">@lang('lang.false')</span>
                                @if($student_answer != 1 || $student_answer == 'not_answered')
                                <span class="icon"><i class="fal fa-times-circle"></i></span>
                                @endif
                                @if($question->true_answer == 0)
                                <span class="icon"><i class="fal fa-check-circle"></i></span>
                                @endif
                            </div>
                        </div>

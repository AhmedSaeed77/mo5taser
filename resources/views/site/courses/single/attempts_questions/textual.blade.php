<div class="question_wrapper">
    ...
    <div class="name_ques">
        ...
        @if($question->contentCategory)
        <span class="icon"><u>{{$question->contentCategory->name ?? ''}}</u> <i class="fal fa-plus"></i></span>
        @endif
    </div>
...
{{--                            allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>--}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text_answer">
                            <textarea class="form-control required_input" placeholder="@lang('lang.answer')"
                             readonly>@if($student_answer == 'not_answered')@lang('lang.not_answered')@else{{$student_answer}} @endif</textarea>
                             @if($answer->type == '0')
                             <span class="icon wrong"><i class="fal fa-times-circle"></i></span>
                             @endif
                             @if($answer->type == '1')
                             <span class="icon correct"><i class="fal fa-check-circle"></i></span>
                             @endif
                             @if($answer->type == '2')
                             <span class="icon incomplete"><i class="fal fa-question-circle"></i></span>
                             @endif
                        </div>
                    </div>
                </div>
        ...
        @if ($question->question_details != NULL || $question->hint_video != NULL || $question->hint_image != NULL)
...
{{--                        --}}
{{--                            <a class="btn-form" data-bs-toggle="collapse" href="#collapseExample{{ $question->id }}" role="button" aria-expanded="false" aria-controls="collapseExample">@lang('lang.hint_video')</a>--}}
{{--                        --}}

...
<section class="payment-page body-inner">
    <div class="container">
        <div class="row">
            ...
            <form action="{{route('assemble_checkout')}}" method="POST">
                @csrf
                <!-- Col -->
                <div class="col-md-8">
                        ...
                        <div class="total">
                            <ul>
                                <li>
                                    ...
                                    <span><strong>{{ $assemble->price }} ر.س</strong></span>
                                </li>
                            </ul>
                        </div>
                        <input type="hidden" name="assemble" value="{{$assemble->id}}">

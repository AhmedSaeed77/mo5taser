                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>@lang('lang.banks')</b></h4>
                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">@lang('lang.iban')</th>
                                            ...
                                            @if ($banks->count() > 0)
                                                @foreach ($banks as $key => $bank)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{$bank->name_ar}}</td>
                                                        <td class="text-center">{{$bank->name_en}}</td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            data-id="{{$bank->id}}"> @lang('lang.delete') </button>
                                                            ...
                                                            <div id="delete-modal{{$key}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="{{route('bank.destroy' ,$bank->id )}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                                            @csrf
                                                                            @method('DELETE')
    ...
    <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('bank.store') }}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="@lang('lang.account_number')" required value="{{ old('account_number') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="@lang('lang.iban')" required value="{{ old('iban') }}">
                                </div>
                            </div>
                        </div>
                    </div>

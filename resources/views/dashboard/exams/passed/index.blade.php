                                                ...
                                                @foreach ($passes as $key => $passe)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{route('pass.edit' ,$passe->id )}}">
                                                            ...
                                                            <div id="delete-modal{{$key}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="{{route('pass.destroy' ,$passe->id )}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                                            @csrf
                                                                            @method('DELETE')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="@lang('lang.attemps')" value="{{ old('attemps') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">

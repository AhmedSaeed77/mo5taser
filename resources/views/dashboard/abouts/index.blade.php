                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>@lang('lang.about_us')</b></h4>
                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">@lang('lang.about_ar')</th>
                                            <th class="text-center">@lang('lang.about_en')</th>
                                            <th class="text-center">@lang('lang.image')</th>
                                            <th class="text-center">@lang('lang.cover')</th>
                                                ...
                                                @foreach ($abouts as $key => $about)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {!! \Illuminate\Support\Str::limit($about->about_ar, 50, '') !!}
                                                        </td>
                                                        <td class="text-center">
                                                            {!! \Illuminate\Support\Str::limit($about->about_en, 50, '') !!}
                                                        </td>
                                                        <td class="text-center"><img src="{{asset($about->image)}}" style="width: 80px; height: 80px; border-radius: 50%"></td>
                                                        <td class="text-center"><img src="{{asset($about->cover)}}" style="width: 80px; height: 80px; border-radius: 50%"></td>
                                                        <td class="text-center">
                                                            ...
                                                            data-id="{{$about->id}}"> @lang('lang.delete') </button>
    ...
    <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('about.store') }}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group no-margin">
                                    ...
                                    style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{{ old('about_ar') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group no-margin">
                                    ...
                                    style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{{ old('about_en') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">

                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>@lang('lang.assemblies_requests')</b></h4>

                                    <div class="row">
                                        <form action="{{route('assembles-requests.index')}}" method="POST">
                                            @csrf
                                            {{method_field("GET")}}
                                                ...
                                                @foreach ($payments as $key => $payment)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{route('assembles-requests.show' ,$payment->id )}}">
                                                                    ...
                                                                    <div id="delete-modal{{$key}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <form action="{{route('assembles-requests.destroy',$payment->id)}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                                                    @csrf
                                                                                    @method('DELETE')

                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>@lang('lang.ratings')</b></h4>
                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">@lang('lang.stars')</th>
                                            ...
                                            @if ($ratings->count() > 0)
                                                @foreach ($ratings as $key => $rating)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{$rating->course->title}}</td>
                                                            ...
                                                            <div id="delete-modal{{$key}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="{{route('rating.destroy' ,$rating->id )}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                                            @csrf
                                                                            @method('DELETE')

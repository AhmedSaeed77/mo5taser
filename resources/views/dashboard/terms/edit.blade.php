                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="col-md-12">
                                        <form action="{{ route('term.update',$term) }}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            placeholder="@lang('lang.title_ar')" required value="{{ $term->title_ar }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            placeholder="@lang('lang.title_en')" required value="{{ $term->title_en }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group no-margin">
                                                            ...
                                                            style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{!! $term->content_ar !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group no-margin">
                                                            ...
                                                            style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{!! $term->content_en !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

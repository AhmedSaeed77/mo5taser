                                    ...
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h4>@lang('lang.why_us') </h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <form action="{{ route('why-us.update',$why) }}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            placeholder="@lang('lang.title_ar')" required value="{{$why->title_ar }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            placeholder="@lang('lang.title_en')" required value="{{$why->title_en }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group no-margin">
                                                            ...
                                                            style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{{$why->content_ar }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group no-margin">
                                                            ...
                                                            style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">{{$why->content_en }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

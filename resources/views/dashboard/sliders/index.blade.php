                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>@lang('lang.slider')</b></h4>
                                            ...
                                            @if ($sliders->count() > 0)
                                                @foreach ($sliders as $key => $slider)
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><img src="{{asset($slider->image)}}" style="width: 80px; height: 80px; border-radius: 50%"></td>
                                                        <td class="text-center">
                                                            ...
                                                            <button class="btn btn-danger" alt="default" data-toggle="modal" data-target="#delete-modal{{$key}}"
                                                                    data-id="{{$slider->id}}"> @lang('lang.delete') </button>
                                                                    ...
                                                                    <div id="delete-modal{{$key}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <form action="{{route('slider.destroy',$slider->id)}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                                                    @csrf
                                                                                    @method('DELETE')

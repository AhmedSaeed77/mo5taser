...
use App\Http\Controllers\Admin\Assemble\Category;
use App\Http\Controllers\Admin\Assemble\Exception;
...
class StoreRequestsController extends Controller
{
    public function index()
    {
        try
        {
            ...
            return view('dashboard.store-requests.index',compact('payments','printed_payments','pdf_payments','all_payments'));
        }
        catch(\Exception $ex)
        {
    ...
    public function show($id)
    {
        ...
        try
        {
            if(isset($payment))
            {
                return view('dashboard.store-requests.show',compact('payment'));
            }
            else
            {
                return back()->with('failed' , __('lang.not_found'));

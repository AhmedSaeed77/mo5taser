...
class unActiveSubscribtion extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        $message_ar = [
            ...
            "body" => " تم الغاء تفعيل اشتراك  " . $course->title_ar,
        ];
        $message_en = [
            "title" => "You have new notification",
            "body" => "  Course subscribtion deactivated  " . $course->title_en,
        ];
        $fields = array(
            'to' => $to,

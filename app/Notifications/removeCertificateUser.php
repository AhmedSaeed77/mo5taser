...
class removeCertificateUser extends Notification
{
    use Queueable;
    protected $subscribe;
    ...
    public function toArray($notifiable)
    {
        ...
        $message_ar = [
            ...
            "body"=>" تم إلغاء تفعيل شهادة  ". $course->title_ar ,
            ];
        $message_en = [
            "title"=>"You have new notification",
            "body"=>"  certificate deactivated  ". $course->title_en ,
            ];
            $fields = array(
                'to'   => $to,
